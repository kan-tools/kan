...
[`ADR-0035`](adrs/0035-sync-layer-staging-plan-and-a-version-roadmap-through-1-0.md)) — see that doc before starting any sync-adjacent
...
Declared in four AX-driven phases ([`ADR-0032`](adrs/0032-verb-lexicon-reorganized-by-ax-phase-mcp-tool-surface-catches-up-to-the.md)) — `kan --help`
...
[`ADR-0018`](adrs/0018-the-kan-companion-tool-scope-boundary-kan-session-removed.md).
